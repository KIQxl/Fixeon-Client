...
import { AddTagInTicketRequest, Category, ChangeTicketCategoryAndDepartament, ChangeTicketStatusRequest, CreateAssignTicketRequest, Departament, Tag, Ticket, TranslatePriority, TranslateStatus } from '../../../core/models/Ticket';
